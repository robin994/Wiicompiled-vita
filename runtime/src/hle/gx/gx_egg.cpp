...
#endif
#ifndef MKW_VITA_DISPLAY_END_FRAME_DECOUPLE
#define MKW_VITA_DISPLAY_END_FRAME_DECOUPLE 0
#endif
...
// EGG::Display::endFrame is only GXDrawDone in RMCP01. With the packetized
// renderer the host wait serializes USER_0 against USER_1; publish the same
// guest-visible completion bit here and let queue/barrier ordering protect EFB.
extern "C" void EGG__Display__endFrame_HLE_80219fb0(CpuContext*) {
#if MKW_VITA_DISPLAY_END_FRAME_DECOUPLE
    GX__FinishInterruptHandler_8016ed94();
#else
    GX__DrawDone_8016eab0();
#endif
}
PPC_NATIVE_OVERRIDE_VOID(80219FB0, EGG__Display__endFrame_HLE_80219fb0, (CpuContext* ctx), (ctx));
